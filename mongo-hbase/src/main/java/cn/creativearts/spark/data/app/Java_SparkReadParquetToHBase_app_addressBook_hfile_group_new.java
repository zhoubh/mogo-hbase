 ...
 * 简化为GroupBy、FlatMapToPair、SortByKey三个环节，去除一个flatMapToPair宽依赖操作
 * =====================测试列名会乱序======================
 */

public class Java_SparkReadParquetToHBase_app_addressBook_hfile_group_new {
    ...
    public static void main(String[] args) throws Exception {
        ...
        }).flatMapToPair(new PairFlatMapFunction<Tuple2<String, Iterable<Row>>, ImmutableBytesWritable, KeyValue>() {
            @Override
            public Iterator<Tuple2<ImmutableBytesWritable, KeyValue>> call(Tuple2<String, Iterable<Row>> tuple2) throws Exception {
                ...
                while (it.hasNext()) {
                    ...
                    for (Tuple2 t : tuple2s) {
                        ...
                        //tps.add(kv);
                        list.add(new Tuple2<>(writable, kv));
                    }
