...
import cn.creativearts.model.SmsInfo;
import cn.creativearts.load.Constants;
...
public class KafkaUtils {
     ...
     * @param msg
     */
    public static void sendMsgToKafka(SmsInfo msg) {
        ...
        while(true){
            ...
            if (records.count() > 0) {
                for (ConsumerRecord<String, String> record : records) {
                    ...
                    SmsInfo smsInfo = JSONObject.toJavaObject(jsonAlarmMsg, SmsInfo.class);
                    LOGGER.info("从kafka接收到的消息是：" + smsInfo.toString());
                }
            }
        }
    }
